...
from ZUnitConvertCODE import conversion_dict as cdict
...
Label(root, text="Quantity").grid(row=0, column=0, columnspan=3, sticky=W)
...
resultVar = StringVar()
resultLabel = Label(root, textvariable=resultVar).grid(row=3,
